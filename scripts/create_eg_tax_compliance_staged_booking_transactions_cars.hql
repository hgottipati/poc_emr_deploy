drop table if exists commerce.tax_compliance_eg_booking_transactions_cars;

CREATE EXTERNAL TABLE `commerce.tax_compliance_eg_booking_transactions_cars`(
 `book_date` string
...
LOCATION
  's3://daps-cdfs-compliance-data/{git-branch-name}/tax_compliance_eg_booking_transactions_cars';
MSCK REPAIR TABLE commerce.tax_compliance_eg_booking_transactions_cars;
