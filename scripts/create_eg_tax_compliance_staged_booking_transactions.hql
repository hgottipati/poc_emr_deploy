DROP TABLE IF EXISTS commerce.tax_compliance_eg_booking_transactions;

CREATE EXTERNAL TABLE `commerce.tax_compliance_eg_booking_transactions`(
 `book_date` string
...
LOCATION
  's3://daps-cdfs-compliance-data/{git-branch-name}/tax_compliance_eg_booking_transactions';
MSCK REPAIR TABLE commerce.tax_compliance_eg_booking_transactions;
